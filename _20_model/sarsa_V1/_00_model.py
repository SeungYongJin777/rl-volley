...
from _20_model import sarsa_v1
...
class Sarsa:
    def __init__(self, conf, policy_name_for_play=None):
        ...
        if self.conf.train_rewrite is not True:
            try:
                self.policy = sarsa_v1._02_qtable.load_qtable(
                    self.policy_path)
            except:
                self.policy = sarsa_v1._02_qtable.create_qtable()
        else:
            self.policy = sarsa_v1._02_qtable.create_qtable()
    ...
    def get_transition(self, env, state_mat):
        ...
        if self.action_next_mat is None:
            action_mat = sarsa_v1._06_algorithm.epsilon_greedy_action_selection(
                policy=self.policy,
                state=state,
        ...
        if done is not True:
            action_next_mat = sarsa_v1._06_algorithm.epsilon_greedy_action_selection(
                policy=self.policy,
                state=state_next,
                epsilon=self.epsilon,
            )
    ...
    def update(self, transition):
        ...
        td_target = sarsa_v1._06_algorithm.calculate_qtarget(
            policy=self.policy,
            reward=reward_next,
    ...
    def get_train_configuration(self):
        train_conf = sarsa_v1._01_params.get_train_params()
        return train_conf
    ...
    def update_epsilon(self):
        ...
        self.epsilon = sarsa_v1._06_algorithm.\
    ...
    def map_to_designed_state(self, state_mat):
        ...
        ===================================================================================================="""
        state_custom = sarsa_v1._03_state_design.calculate_state_key(
            state_mat)
    ...
    def map_to_designed_action(self, action_mat):
        ...
        action_custom = action_mat *\
            sarsa_v1._04_action_space_design.action_mask()
    ...
    def map_to_designed_reward(self, reward_mat):
        ...
        ===================================================================================================="""
        reward_custom = sarsa_v1._05_reward_design.calculate_reward(
            reward_mat)
    ...
    def save(self):
        ...
        ================================================================================================"""
        sarsa_v1._02_qtable.save_qtable(self.policy, self.policy_path)
