...
class Qarsa:
    def __init__(self, conf, policy_name_for_play=None):
        ...
        if self.conf.train_rewrite is not True:
            try:
                self.policy = qarsa._02_qtable.load_qtable(
                    self.policy_path)
            except:
                self.policy = qarsa._02_qtable.create_qtable()
        else:
            self.policy = qarsa._02_qtable.create_qtable()
    ...
    def get_transition(self, env, state_mat):
        ...
        if done is not True:
            action_next_mat = qarsa._06_algorithm.epsilon_greedy_action_selection(
                policy=self.policy,
                state=state_next,
                epsilon=self.epsilon,
            )
    ...
    def update(self, transition):
        ...
        td_target = qarsa._06_algorithm.calculate_qtarget(
            policy=self.policy,
            reward=reward_next,
            ...
            lambda_blend=self.train_conf["lambda_blend"],
        )
    ...
    def get_train_configuration(self):
        train_conf = qarsa._01_params.get_train_params()
        return train_conf
    ...
    def update_epsilon(self):
        ...
        self.epsilon = qarsa._06_algorithm.\
    ...
    def map_to_designed_state(self, state_mat):
        ...
        ===================================================================================================="""
        state_custom = qarsa._03_state_design.calculate_state_key(
            state_mat)
    ...
    def save(self):
        ...
        ================================================================================================"""
        qarsa._02_qtable.save_qtable(self.policy, self.policy_path)
