...
class Dqn:
    def __init__(self, conf, policy_name_for_play=None):
        ...
        self.state_dim = int(dqn_wjc._03_state_design.get_state_dim())
        self.dim_action = len(dqn_wjc._04_action_space_design.action_mask())
        ...
        self.policy = dqn_wjc._02_network.create_nn(
        ...
        self.target_policy = dqn_wjc._02_network.create_nn(
            self.state_dim, self.dim_action,
            self.hidden_dim, self.hidden_layer_count,
        ).to(self.device)
    ...
    def get_transition(self, env, state_mat):
        ...
        action_mat = dqn_wjc._06_algorithm.epsilon_greedy_action_selection(
    ...
    def get_train_configuration(self):
        train_conf = dqn_wjc._01_params.get_train_params()
        return train_conf
    ...
    def update_epsilon(self):
        ...
        self.epsilon = dqn_wjc._06_algorithm.\
    ...
    def map_to_designed_state(self, state_mat):
        ...
        ===================================================================================================="""
        state_custom = dqn_wjc._03_state_design.calculate_state_key(
            state_mat)
    ...
    def map_to_designed_action(self, action_mat):
        ...
        action_custom = action_mat *\
            dqn_wjc._04_action_space_design.action_mask()
    ...
    def map_to_designed_reward(self, reward_mat):
        ...
        ===================================================================================================="""
        reward_custom = dqn_wjc._05_reward_design.calculate_reward(
            reward_mat)
    ...
    def save(self):
        dqn_wjc._02_network.save_nn(self.policy, self.policy_path)
